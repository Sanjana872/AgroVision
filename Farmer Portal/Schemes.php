 ...
 <body>
      ...
      <body>
           ...
           <div class="row" style="text-align:center;">
                ...
                <div class="col-md-2 col-sm-12">
                     <a href="CallCenter.php" id="navbar"><label>Call Centers/SMS</label></a>
                </div>
           </div>
           <hr>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          ...
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Website/insta.jpg" alt="Third slide">
                          </div>
                          <div class="carousel-item">
           ...
           <div class="features container">
                ...
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     ...
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/Pradhan-Mantri-Fasal-Bima-Yojana-PMFBY.jpg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
